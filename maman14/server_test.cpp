...
namespace
{
  ...
  static const std::vector<uint8_t> request_sav_1{0x04, 0xD2, 0x00, 0x00, 0x01, 0x64, 0x03, 0x00, 'a', 'b', 'c', 0x01, 0x00, 0x00, 0x00, 0x61};
  static const std::vector<uint8_t> request_sav_2{0x04, 0xD2, 0x00, 0x00, 0x01, 0x64, 0x03, 0x00, 'b', 'b', 'c', 0x01, 0x00, 0x00, 0x00, 0x61};
  static const std::vector<uint8_t> request_res_1{0x04, 0xD2, 0x00, 0x00, 0x01, 0xC8, 0x03, 0x00, 'a', 'b', 'c'};
  static const std::vector<uint8_t> request_res_2{0x04, 0xD2, 0x00, 0x00, 0x01, 0xC8, 0x03, 0x00, 'b', 'b', 'c'};
  static const std::vector<uint8_t> request_del_1{0x04, 0xD2, 0x00, 0x00, 0x01, 0xC9, 0x03, 0x00, 'a', 'b', 'c'};
  static const std::vector<uint8_t> request_del_2{0x04, 0xD2, 0x00, 0x00, 0x01, 0xC9, 0x03, 0x00, 'b', 'b', 'c'};
  ...
  static const std::vector<uint8_t> request_inv_2{0x04, 0xD2, 0x00, 0x00, 0x00, 0x64, 0x03, 0x00, 0x61, 0x62, 0x63, 0x03, 0x00, 0x00, 0x00, 0x61, 0x00, 0x63};
  static const std::vector<uint8_t> request_inv_3{0x04, 0xD2, 0x00, 0x00, 0x00, 0x64, 0x03, 0x00, 0x61, 0x60, 0x63, 0x03, 0x00, 0x00, 0x00, 0x61, 0x00, 0x63};
  ...
  static const std::vector<uint8_t> response_res_1{VRSN, 0xD2, 0x00, 0x03, 0x00, 'a', 'b', 'c', 0x01, 0x00, 0x00, 0x00, 0x61};
  static const std::vector<uint8_t> response_res_2{VRSN, 0xD2, 0x00, 0x03, 0x00, 'b', 'b', 'c', 0x01, 0x00, 0x00, 0x00, 0x61};
  static const std::vector<uint8_t> response_sav_1{VRSN, 0xD4, 0x00, 0x03, 0x00, 'a', 'b', 'c'};
  static const std::vector<uint8_t> response_sav_2{VRSN, 0xD4, 0x00, 0x03, 0x00, 'b', 'b', 'c'};
  static const std::vector<uint8_t> response_del_1{VRSN, 0xD4, 0x00, 0x03, 0x00, 'a', 'b', 'c'};
  static const std::vector<uint8_t> response_del_2{VRSN, 0xD4, 0x00, 0x03, 0x00, 'b', 'b', 'c'};
  static const std::vector<uint8_t> resp_no_file_1{VRSN, 0xE9, 0x03, 0x03, 0x00, 'a', 'b', 'c'};
  static const std::vector<uint8_t> resp_no_file_2{VRSN, 0xE9, 0x03, 0x03, 0x00, 'b', 'b', 'c'};
  ...
  static const std::vector<uint8_t> response_list_payload_1{'a', 'b', 'c', '\n'};
  static const std::vector<uint8_t> response_list_payload_2{'b', 'b', 'c', '\n'};
  static const std::vector<uint8_t> response_list_payload_12{'a', 'b', 'c', '\n', 'b', 'b', 'c', '\n'};
